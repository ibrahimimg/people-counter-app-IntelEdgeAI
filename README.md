...
[![Demo](./images/demo.png)](https://youtu.be/5Hkej4hC0tc)

| Details            |              |
|-----------------------|---------------|
| Programming Language: |  Python 3.5 or 3.6 |

![people-counter-live](./images/people-counter-live.png)
...
i have Added a button to the UI to shut off the camera feed and show stats only (the button can be used as well to turn on camera feed back). this will allow user to save data more espicially if there is limited bandwidth.

![people-counter-no-feed](./images/people-counter-static.png)
...
![on-udacity-workspace](./images/on-udacity-workspace.png)

If working locally, to see the output on a web based interface, open the link [http://0.0.0.0:3004](http://0.0.0.0:3004/) in a browser. check your server address after running npm run dev (step 2)
![local-server-ui](./images/local-server-ui.png)
![on-local](./images/on-local.png)
...
```
python3.5 main.py -d MYRIAD -i resources/Pedestrian_Detect_2_1_1.mp4 -m model/person-detection-retail-0013.xml -pt 0.6 | ffmpeg -v warning -f rawvideo -pixel_format bgr24 -video_size 768x432 -framerate 24 -i - http://0.0.0.0:3004/fac.ffm
```
